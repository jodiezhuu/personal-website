...
export default function Projects() {
    ...
    <div className='container'>
        ...
        <img className='neurophoto' src="images/brains.jpg" alt="NeuroPhoto"></img>
    </div>
